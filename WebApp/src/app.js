...
socket.on('mobile-connected', () => {
    document.getElementById('connection-status').innerHTML = '<span id="connect-text" class="text-green-500">CONNECTED TO</span> YOUR COMPUTER';
...
function showDisconnectedStatus() {
    document.getElementById('connection-status').innerHTML = '<span id="connect-text" class="text-orange-500">CONNECT TO</span> YOUR COMPUTER';
...
function showCardDetails(cardId) {
    ...
    if (cardId === 'photoshop') {
      ...
      buttonCtrlC.classList.add('bg-green-500', 'hover:bg-green-700', 'text-white', 'font-bold', 'py-2', 'px-4', 'rounded', 'm-2');
      
      const buttonCtrlV = document.createElement('button');
      buttonCtrlV.textContent = 'CTRL + V';
      buttonCtrlV.onclick = () => buttonPressed('ctrl-v');
      buttonCtrlV.classList.add('bg-green-500', 'hover:bg-green-700', 'text-white', 'font-bold', 'py-2', 'px-4', 'rounded', 'm-2');
